...
"%ILCPATH%\ilc" zerosharp.ilexe -r:Test.CoreLib.dll -o zerosharp.obj --systemmodule Test.CoreLib --map zerosharp.map -O --noscan -g --directpinvoke:kernel32
link zerosharp.obj "%SDKPATH%\bootstrapper.lib" "%SDKPATH%\Runtime.lib" kernel32.lib ole32.lib advapi32.lib /incremental:no /debug /opt:ref /subsystem:console /ENTRY:wmainCRTStartup
